    ...
    <div class="container flex flex-col md:flex-row items-center md:items-stretch md:gap-12 p-4 m-auto prose md:prose-lg max-w-7xl">
      ...
      <div class="flex-3">
        ...
        <div class="flex flex-row justify-center pt-4">
          <iframe src="https://www.facebook.com/plugins/video.php?height=476&href=https%3A%2F%2Fwww.facebook.com%2Fschlierelacht%2Fvideos%2F3538727499751138%2F&show_text=false&width=267&t=0"
                  width="347"
                  height="619"
