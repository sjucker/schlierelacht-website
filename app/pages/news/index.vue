<template>
  <div class="p-4 md:p-6">
    ...
    <div v-if="pending" class="text-sm text-neutral-400">News werden geladen…</div>

    <div v-else-if="!news?.length" class="text-sm text-neutral-500">Aktuell sind keine News vorhanden.</div>
    ...
    <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <!-- Image -->
        <div class="h-48 bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center overflow-hidden">
          <NuxtImg
              v-if="item.cloudflareId"
              provider="cloudflare"
        ...
        <div class="flex flex-col gap-3 p-4 flex-1">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 m-0 line-clamp-4 leading-relaxed">{{ item.introText }}</p>
